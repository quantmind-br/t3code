...
/** Meta mark. Two gradients need document-unique ids since the icon can render many times per page. */
export const MuseIcon: Icon = ({ className, ...props }) => {
  const id = useId().replaceAll(":", "");
  const gradientA = `${id}-meta-a`;
  const gradientB = `${id}-meta-b`;
  return (
    <svg {...props} viewBox="0 0 290 191" fill="none" className={className}>
      <defs>
        <linearGradient
          id={gradientA}
          x1="61"
